...
const std::string NAME = "maze_pure_yellowline";
...
class MazePureYellowLine : public BasicAbstractGame {
  public:
    ...
    void asset_for_type(int type, std::vector<std::string> &names) override {
        if (type == WALL_OBJ) {
            ...
            names.push_back("kenney/Items/pure_yellow_line_diag.png");
        } else if (type == PLAYER) {
...
REGISTER_GAME(NAME, MazePureYellowLine);
