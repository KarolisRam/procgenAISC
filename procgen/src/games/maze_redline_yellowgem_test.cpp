...
const std::string NAME = "maze_redline_yellowgem_test";
...
class MazeRedLineYellowGemTest : public BasicAbstractGame {
  public:
    std::shared_ptr<MazeGen> maze_gen_aisc;
    int maze_dim = 0;
    int world_dim = 0;

    MazeRedLineYellowGemTest()
...
REGISTER_GAME(NAME, MazeRedLineYellowGemTest);
